...
public class DangNhapFrm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("HỆ THỐNG QUẢN LÝ PHÒNG KHÁM");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            int phongKhamID = dangnhap.checking(username, password);
            if (phongKhamID != -1) {
                setVisible(false);
                MainFrm mainFrm = new MainFrm(phongKhamID);
                mainFrm.setVisible(true);
            } else {
                txt_username.setText("");
                txt_password.setText("");
                JOptionPane.showMessageDialog(rootPane, "Sai mật khẩu hoặc tài khoản không tồn tại !");
            }
        } catch (Exception ex) {
